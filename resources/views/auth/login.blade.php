    ...
    <section class="conn" data-aos=" fade-up" data-aos-easing="ease-in-out" data-aos-duration="500" style="height: 55vh;">
        <div class="conn-child d-flex justify-content-between align-items-center">
            ...
            <div class="col-lg-6 position-relative d-flex align-items-center justify-content-center flex-column">
                <div class="col-md-12 d-flex align-items-end justify-content-center conn-return p-3">
                ...
                <form action="{{ route('login') }}" method="post" role="form" id="form-contain-conn">
                    ...
                    <div class="form-row">
                        <div class="col-md-10 form-group form-email">
                        ...
                        <div class="col-md-10 form-group form-pwd">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-5 form-group" id="form-fgpwd">
                            <div class="text-center d-flex justify-content-end"><a href="javascript:void(0)" class="fgpwd">Mot de passe
                                    oublié?</a></div>
                            <div class="validate"></div>
                        </div>
                    </div>
                ...
                <form action="{{ route('password.email') }}" method="post" id="form-contain-fgpwd"
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-10 form-group" id="return-to-conn">
