...
.disabled {
    ...
    .btn {
    transition: background-color 1s ease; /* Transition douce pour la couleur de fond */
    }
    .btnas-ends {
    transition: background-color 1s ease; /* Transition douce pour la couleur de fond */
    }
                                    ...
                                    <div class="input-group" data-question-index="0">
                                        <div class="questionnaire">
                                            <div class="input-group">
                                                <div class="display-1">
                                                    <div class="textarea">
                                                        <textarea name="sections[0][questions][0][libquestion]" id="previews" required placeholder="Question" oninput="autoResize(this);"></textarea>
                                                    </div>
                ...
                <div class="wo">
                    ...
                    <div class="input-group select-group">
                        ...
                        <select name="classe_id" id="positions2" class="select-effect-1  psi13" required>
                            ...
                            @foreach ($classes as $classe)
                                <option value="{{ $classe->id }}" data-classe="{{ $classe->nomclasse }} "  data-filiere="{{ json_encode($filiereClasses[$classe->nomclasse], JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); }}">{{ $classe->nomclasse }}</option>
                            @endforeach
                        </select>
                        <span class="border"></span>
                        <div class="error-message" id="positions2-error" style="display: none; color: red;">Veuillez
                    ...
                    <div class="input-group">
                        <label for="position" class="label">Filière</label>
                            <input type="text" name="filiere_id" id="positions1" class="select-effect-1 fil13" title="Vous ne pouvez pas modofier ce champs" required  readonly/>
                            <span class="border"></span>
                    </div>
                    <div class="input-group time-group">
                        <label for="time" class="label">Durée</label>
                    ...
                    button.addEventListener("click", function() {
                        ...
                        if (questionnaire) {
                            ...
                            if (inputGroup) {
                                ...
                                if (nextElement && nextElement.classList.contains("question-separator")) {
                                    nextElement.remove();
                                } 
                                // Sinon, si l'élément précédent a la classe "question-separator"
                                else if (previousElement && previousElement.classList.contains("question-separator")) {
...
document.querySelector(".Ajouter-section")?.addEventListener("click", function(event) {
    ...
    if (sectionsContainer) {
        ...
        newSections.querySelector('.btnas-ends').addEventListener('click', function() {
            const parentSa = newSections.closest('.sa'); // Trouver l'élément parent avec la classe 'sa'
