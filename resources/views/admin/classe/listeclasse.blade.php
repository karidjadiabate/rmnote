                        ...
                        @foreach ($classes as $classe)
                            <tr>
                                ...
                                <td data-label="Action" class="action-icons no-print">
                                    ...
                                    <button class="btn btn-sm solid_distances" data-bs-toggle="modal"
                            ...
                            <div class="modal fade " id="editClasse{{ $classe->id }}" tabindex="-1"
                            ...
                            <div class="modal fade" id="deleteclasse{{ $classe->id }}" tabindex="-1"
