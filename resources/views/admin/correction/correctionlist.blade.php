...
<body>
    ...
    <div class="container printableArea principal">
        ...
        <div class="printableArea">
            ...
            <h2 class="text-start text-title">Sujets corrigés</h2>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap action-buttons mb-3 no-print">
                ...
                <div class="d-flex justify-content-end flex-wrap action-buttons">
                    ...
                    <!-- <button class="btn btn-custom btn-imprimer disabled" id="printBtn" onclick="printDiv()"><i
                    ...
                    <!-- <button class="btn btn-custom btn-ajouter" data-bs-toggle="modal"
                        ...
                        data-bs-target="#etablissementModal"><i class="fa fa-plus"></i> Créer un dossier</button> -->
            ...
            <div class="row action-buttons mt-5">

            @foreach($listesujets as $ls)

                <a href="{{ route('correction.correction', ['id' =>  $ls->id]) }}" class="col-sm-6 col-md-3">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">{{$ls->code}}</h5>
            ...
            <!-- <div class="d-flex flex-column flex-wrap  mb-3">
                <div class="fichier_file">
                    <i class="fa-solid fa-file"></i>
                </div></br>
                <span class="nom_fichier">S0001_Economie_CF3A</span>
            </div> -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('etablissement.store') }}" method="POST" class="needs-validation"
                    ...
                    <div class="modal-footer d-flex justify-content-between margin">
