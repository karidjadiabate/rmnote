...
@section("content")
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-around">
      ...
      <div class="logo">
        <img src="/assets/img/logo ROMNOTE 2.png" alt="" class="text-light logo-text">
      </div>
      ...
      <div class="text-car w-75 d-flex align-items-center justify-content-start text-start flex-column">
        ...
        <form class="d-flex mb-3">
            <a href="{{ route('demandeinscription') }}" id="btnInscription" type="submit"
                class="btn btn-custom btn-customs">Inscrivez-vous</a>
            <a href="#demo" class="btn btn-video">
                <i class="fa-solid fa-play"></i> Regardez une démo
            </a>
        </form>
      </div>
    </div>
      ...
      <div class="container  d-flex align-items-center justify-content-center">
          <div class="row col-md-12 feature-row">
            ...
            <div class="col-6 col-sm-6  col-md-4 text-center mb-5">
                ...
                <h5 class="feature-heading">Accès rapide aux résultats</h5>
            </div>
            </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
        <img src="/assets/img/logo ROMNOTE 1.png" alt="" class="text-light logo-text image images culos">
        ...
        <form action="{{route('demo.store')}}" method="POST">
          ...
          <div class="form-group col-md-11 d-flex justify-content-center">
            <input type="text" name="nom" class="form-control margin-text" id="nom" aria-describedby="emailHelp" placeholder="Entrez votre nom" required>
          </div>

          <div class="form-group col-md-11 d-flex justify-content-center">
            <input type="text" name="prenom" class="form-control margin-text" id="prenom" aria-describedby="emailHelp" placeholder="Entrez votre prenom" required>
          </div>
          ...
          <div class="form-group col-md-11 d-flex justify-content-center">
            <input type="checkbox" id="exampleInputEmail1" required class="margin-light"> <span style="color: #4a3dbb;font-size:13px;">J'ai lu et j'accepte les Termes et conditions ainsi que la <a href="" style='text-decoration: underline;color: #4a3dbb;'>Politique de confidentialité.</a> </span>
          </div>
